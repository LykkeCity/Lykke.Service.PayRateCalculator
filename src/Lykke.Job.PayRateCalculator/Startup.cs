...
using Lykke.Job.PayRateCalculator.Settings;
using Lykke.Job.PayRateCalculator.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.PayRateCalculator
{
    [PublicAPI]
    public class Startup
    {
        private const string ApiVersion = "v1";
        private const string ApiName = "PayRateCalculatorJob API";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddLykkeLogging(
                    settingsManager.ConnectionString(s => s.PayRateCalculatorJob.Db.LogsConnString),
                    "PayRateCalculatorJobLog",
                ...
                builder.RegisterModule(new JobModule(appSettings.PayRateCalculatorJob, settingsManager.Nested(x => x.PayRateCalculatorJob)));
