...
using Lykke.Service.PayRateCalculator.Settings;
...
namespace Lykke.Service.PayRateCalculator
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        {
            ApiTitle = "PayRateCalculator API",
            ApiVersion = "v1"
        };
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "PayRateCalculatorLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.PayRateCalculatorService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("PayRateCalculator", channelOptions =>
                        {
